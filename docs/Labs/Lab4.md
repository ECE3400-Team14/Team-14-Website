...
Enable scaling --> COM14 at 0x3E is set to 0x08<br/>
Use external clock as internal clock --> CLKRC at 0x11 is set to 0xC0<br/>
Pixel and resolution format --> COM7 at 0x12 is set to 0xC<br/>
Set the gain ceiling to something stable --> COM9 at 0x14 is set to 0x01<br/>
Set pixel format --> COM15 at 0x40 is set to 0xD0<br/>
Enable a color bar test --> COM17 at 0x42 is set to 0x8<br/>
Vertical and mirror flip --> MVFP at 0x1E is set to 0x30<br/>
